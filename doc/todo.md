...
- [x] **Implement Core REST API (`rag/server.py` -> `api/`)**
    ...
    - [x] Manage the *single* connection to ChromaDB and SQLite here.
...
- [x] *Create `server.py` MCP* (Superseded by API client approach)
- [x] *CLI management interface* (Superseded by API client approach)
